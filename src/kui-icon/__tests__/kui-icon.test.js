...
describe("Testing <kui-icon> attributes", () => {
	...
	])("Testing the sync between attribute and property for %s", (attributeName, propertyName, value) => {
	...
	])("Updating the %s attribute updates the inner icon element's class names", (attributeName, value) => {
		kuiIcon.setAttribute(attributeName, value);
